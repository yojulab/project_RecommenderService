...
def scrapping_site():
    ...
    try:
        ...
        #     print('프로그래머스', uri, url, 'IT', category_middle, category_small, search_word, nowDate, recruit_title,
            #     company_name, detail_uri, job, work, company, career, money, start_date, end_date, position, service,
            #     intro, cond, prefe, culture, table)
            cursor.execute("INSERT INTO SCRAPPING_SITE"
